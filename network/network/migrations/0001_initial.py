# Generated by Django 3.2.8 on 2021-12-31 02:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('of', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followings_of', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Followers',
            fields=[
                ...
                ('of', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followers_of', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
